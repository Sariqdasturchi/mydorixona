            ...
            <div className="homeCont">
                ...
                <div className="alomat">
                    <div className="alomatBtn">
                        <button className="">
                            <Link to='/askorbinka'>Askorbinka </Link>
                        </button>

                        <button className="">
                            <Link to='/elevit-pronatal'>Elevit pronatal  </Link>
                        </button>

                        <button className="">
                            <Link to='/omega-3'>Omega 3</Link>
                        </button>
                        <button className="">
                            <Link to='/pivishan'>Pivishan </Link>
                        </button>
                        <button className="">
                            <Link to='/toufon'>Toufon</Link>
                        </button>
                    </div>
                </div>
